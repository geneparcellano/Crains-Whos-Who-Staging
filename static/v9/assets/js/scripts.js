...
function initiateAutoComplete() {
	...
	var allFirst = [],
		allLast = [],
		allCompanies = [], //from crain's company database
		allPrimaryCo = [], //who's who primary companies
		allProfAssoc = [],
		allCivicAffil = [],
		allUndergrad = [],
		allGrad = [],
	...
	*****************************************************************************/
	$.each(obj.whoswho, function(i, whoswho) {
		...
		*****************************************************************************/
		...
		pushData(whoswho.primaryCo, allPrimaryCo);
...
function updateScore() {
	...
	*****************************************************************************/
	function specialConnections() {
		...
		$('#overlay-your-score .score').html('You are connected to '+totalMatch+' of the Who&rsquo;s who which gives you a score of <strong class="your-score">'+finalScore+'</strong>');
